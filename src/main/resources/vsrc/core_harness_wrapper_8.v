...
(
   ...
   assign dut_harness.commit.arch_valids[3] = commit_arch_valids_3;
   assign dut_harness.commit.arch_valids[4] = commit_arch_valids_4;
   assign dut_harness.commit.arch_valids[5] = commit_arch_valids_5;
   assign dut_harness.commit.arch_valids[6] = commit_arch_valids_6;
   assign dut_harness.commit.arch_valids[7] = commit_arch_valids_7;
   ...
   assign dut_harness.commit.uops[3].ldst = commit_uops_3_ldst;
   assign dut_harness.commit.uops[4].ldst = commit_uops_4_ldst;
   assign dut_harness.commit.uops[5].ldst = commit_uops_5_ldst;
   assign dut_harness.commit.uops[6].ldst = commit_uops_6_ldst;
   assign dut_harness.commit.uops[7].ldst = commit_uops_7_ldst;
   ...
   assign dut_harness.commit.uops[3].dst_rtype = commit_uops_3_dst_rtype;
   assign dut_harness.commit.uops[4].dst_rtype = commit_uops_4_dst_rtype;
   assign dut_harness.commit.uops[5].dst_rtype = commit_uops_5_dst_rtype;
   assign dut_harness.commit.uops[6].dst_rtype = commit_uops_6_dst_rtype;
   assign dut_harness.commit.uops[7].dst_rtype = commit_uops_7_dst_rtype;
   ...
   assign dut_harness.commit.uops[3].debug_pc = commit_uops_3_debug_pc;
   assign dut_harness.commit.uops[4].debug_pc = commit_uops_4_debug_pc;
   assign dut_harness.commit.uops[5].debug_pc = commit_uops_5_debug_pc;
   assign dut_harness.commit.uops[6].debug_pc = commit_uops_6_debug_pc;
   assign dut_harness.commit.uops[7].debug_pc = commit_uops_7_debug_pc;
   ...
   assign dut_harness.commit.uops[3].debug_tag = commit_uops_3_debug_tag;
   assign dut_harness.commit.uops[4].debug_tag = commit_uops_4_debug_tag;
   assign dut_harness.commit.uops[5].debug_tag = commit_uops_5_debug_tag;
   assign dut_harness.commit.uops[6].debug_tag = commit_uops_6_debug_tag;
   assign dut_harness.commit.uops[7].debug_tag = commit_uops_7_debug_tag;
   ...
   assign dut_harness.commit.uops[3].debug_wdata = commit_uops_3_debug_wdata;
   assign dut_harness.commit.uops[4].debug_wdata = commit_uops_4_debug_wdata;
   assign dut_harness.commit.uops[5].debug_wdata = commit_uops_5_debug_wdata;
   assign dut_harness.commit.uops[6].debug_wdata = commit_uops_6_debug_wdata;
   assign dut_harness.commit.uops[7].debug_wdata = commit_uops_7_debug_wdata;
   ...
   assign dut_harness.commit.uops[3].debug_vec_wdata = commit_uops_3_debug_vec_wdata;
   assign dut_harness.commit.uops[4].debug_vec_wdata = commit_uops_4_debug_vec_wdata;
   assign dut_harness.commit.uops[5].debug_vec_wdata = commit_uops_5_debug_vec_wdata;
   assign dut_harness.commit.uops[6].debug_vec_wdata = commit_uops_6_debug_vec_wdata;
   assign dut_harness.commit.uops[7].debug_vec_wdata = commit_uops_7_debug_vec_wdata;
   ...
   assign dut_harness.commit.uops[3].debug_vec_wmask = commit_uops_3_debug_vec_wmask;
   assign dut_harness.commit.uops[4].debug_vec_wmask = commit_uops_4_debug_vec_wmask;
   assign dut_harness.commit.uops[5].debug_vec_wmask = commit_uops_5_debug_vec_wmask;
   assign dut_harness.commit.uops[6].debug_vec_wmask = commit_uops_6_debug_vec_wmask;
   assign dut_harness.commit.uops[7].debug_vec_wmask = commit_uops_7_debug_vec_wmask;
   ...
   assign dut_harness.commit.uops[3].debug_inst = commit_uops_3_debug_inst;
   assign dut_harness.commit.uops[4].debug_inst = commit_uops_4_debug_inst;
   assign dut_harness.commit.uops[5].debug_inst = commit_uops_5_debug_inst;
   assign dut_harness.commit.uops[6].debug_inst = commit_uops_6_debug_inst;
   assign dut_harness.commit.uops[7].debug_inst = commit_uops_7_debug_inst;
