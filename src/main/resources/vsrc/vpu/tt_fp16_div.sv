...
// 16-bit IEEE 754 Floating-Point Division Unit  
...
module tt_fp16_div (
    ...
    input  logic [15:0] i_a,        // Dividend (vs2)
    input  logic [15:0] i_b,        // Divisor (vs1)  
    input  logic [2:0]  i_rm,       // Rounding mode
    
    // Results (IEEE FP16 format)
    output logic [15:0] o_result,   // Division result
