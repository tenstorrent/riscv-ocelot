module tt_scoreboard_ovi(
  ...
  assign ldb_alloc_msk = ldb_alloc_msk_2x[15:8] | ldb_alloc_msk_2x[ 7:0];
  ...
  assign ldb_alloc_ack = ldb_alloc_valid && ~|(ldb_valid & ldb_alloc_msk);
