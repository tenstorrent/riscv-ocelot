...
always_comb begin
	casez({Opcode[6], Opcode[5], Opcode[4], Opcode[3], Opcode[2], Opcode[1], Opcode[0], funct3[2], funct3[1], funct3[0], funct7[6], funct7[5], funct7[4], funct7[3], funct7[2], funct7[1], mop[1], mop[0]})
	    ...
	    18'b1010111_100_100001_??  :  EncType[4] = 1'b1;  // vdiv.vx - funct7[6:1]=100001, funct3=110
	    ...
	    18'b1010111_010_100000_??  :  EncType[4] = 1'b1;  // vfdiv.vv - funct7[6:1]=100000, funct3=001
	    18'b1010111_110_100000_??  :  EncType[4] = 1'b1;  // vfdiv.vf - funct7[6:1]=100000, funct3=101
	    18'b1010111_110_100001_??  :  EncType[4] = 1'b1;  // vfrdiv.vf - funct7[6:1]=100001, funct3=101
	...
	casez({Opcode[6], Opcode[5], Opcode[4], Opcode[3], Opcode[2], Opcode[1], Opcode[0], funct3[2], funct3[1], funct3[0], funct7[6], funct7[5], funct7[4], funct7[3], funct7[2], funct7[1], funct7[0], mop[0]})
	    ...
	    18'b1010111_010_100000_??  :  EncType[3] = 1'b1;  // vfdiv.vv - funct7[6:1]=100000, funct3=001
	    18'b1010111_110_100000_??  :  EncType[3] = 1'b1;  // vfdiv.vf - funct7[6:1]=100000, funct3=101
	    18'b1010111_110_100001_??  :  EncType[3] = 1'b1;  // vfrdiv.vf - funct7[6:1]=100001, funct3=101
	...
	casez({Opcode[6], Opcode[5], Opcode[4], Opcode[3], Opcode[2], Opcode[1], Opcode[0], funct3[2], funct3[1], funct3[0], funct7[6], funct7[5], funct7[4], funct7[3], funct7[2], funct7[1], funct7[0], mop[1], mop[0]})
	    ...
	    19'b1010111_010_100000_???  :  EncType[0] = 1'b1;  // vfdiv.vv - funct7[6:1]=100000, funct3=001
	    19'b1010111_110_100000_???  :  EncType[0] = 1'b1;  // vfdiv.vf - funct7[6:1]=100000, funct3=101
	    19'b1010111_110_100001_???  :  EncType[0] = 1'b1;  // vfrdiv.vf - funct7[6:1]=100001, funct3=101
...
always_comb begin
	casez({Opcode[6], Opcode[5], Opcode[4], Opcode[3], Opcode[2], Opcode[1], Opcode[0], funct3[2], funct3[1], funct3[0], funct7[6], funct7[5], funct7[4], funct7[3], funct7[2], funct7[1], funct7[0]})
	    ...
	    17'b1010111_010_100000_?  :  SrcA[1] = 1'b1;  // vfdiv.vv - vs1 used
